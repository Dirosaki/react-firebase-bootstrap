...
Este projeto é uma aplicação de publicação de eventos desenvolvida no curso de [React JS + Firebase + Bootstrap](https://www.udemy.com/course/react-js-firebase-bootstrap-projeto-passo-a-passo/). 
...
Em seguida, será a aplicação será aberta em seu navegador.
